...
which data format you want by using the "Content-Type" field in the header of
the HTTP GET request. For example, using ``curl`` you would do

    ``curl -X GET -H "Content-Type: application/json" http://api.ids.ac.uk/a/documents/1234/short``
